...
public class TargetPoint extends PathFindNode {
    ...
    private static final TargetPoint[] TARGET_POINTS = {
            new TargetPoint(11.2681d - 0.02d, -9.8d, 5.1125d + 0.01d, POI_Id.POINT_1, 1, 30),
            ...
            new TargetPoint(10.94, -8.524172, 4.86059, POI_Id.POINT_5, 5, 30),
    ...
    private static final TargetPoint[] REAL_TARGET_POINTS = {
            new TargetPoint(11.2746d, -9.92284d, 5.2988d, POI_Id.REAL_POINT_1, 1, 30),
            new TargetPoint(10.612d, -9.0709d, 4.48d, POI_Id.REAL_POINT_2, 2, 20),
            new TargetPoint(10.71d, -7.7d, 4.48d, POI_Id.REAL_POINT_3, 3, 40),
            new TargetPoint(10.51d, -6.7185d, 5.1804, POI_Id.REAL_POINT_4, 4, 20),
    };
