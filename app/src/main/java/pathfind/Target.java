...
public class Target extends PointOfInterest {
    ...
    private static final Target[] TARGETS = {
            ...
            new Target(10.6031, -7.71007, 3.76093, POI_Id.TARGET_2, 0.03),
            new Target(9.866984, -6.673972, 5.09531, POI_Id.TARGET_3, 0.05),
            new Target(11.102, -8.0304, 5.9076, POI_Id.TARGET_4, 0.04),
            new Target(12.023, -8.989, 4.8305, POI_Id.TARGET_5, 0.04)
    };
